...
public abstract class IndexFragment extends Fragment {
    ...
    /**
     * IndexFragment onCreate, 配置除View以外所有的部分
     */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        comparator = new Comparator<IndexItem>() {
            ...
            public int compare(IndexItem lhs, IndexItem rhs) {
                return IndexFragment.this.compare(alphaMap, lhs, rhs);
            }
        };
        //初始化字母表, 和快速排序辅助Map
        alphas = getAlphas();
        ...
        adapter = new BaseAdapter() {
            ...
            public int getViewTypeCount() {
                return IndexFragment.this.getViewTypeCount();
            }

            @Override
            public int getItemViewType(int position) {
                return IndexFragment.this.getItemViewType(position);
            }

            @Override
            public int getCount() {
                return IndexFragment.this.getCount();
            }
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                return IndexFragment.this.getView(position, convertView, parent);
            }
        };
        //数据, 默认size为空
